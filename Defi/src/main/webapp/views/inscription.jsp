...
<div class="main-nav">
	...
	<div class="container">
		<div class="panel panel-default">
			<div class="panel-heading"> <h2 style="text-align: center; font-family: fantasy;">Inscription</h2></div>
			<div class="panel-body">
				<f:form  id="registration-form" method="post" class="form-horizontal" action="inscription" modelAttribute="inscription">
					<div  class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<f:input type="password" class="form-control" id="confirmpassword" name="confirmpassword" placeholder="Confirmez MDP" path="password2"/>	
						</div>
					</div>					
					<div class="form-group">
